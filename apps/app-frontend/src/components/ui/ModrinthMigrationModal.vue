		...
		<div class="flex w-[30rem] max-w-full flex-col gap-4">
			...
			<div class="rounded-xl border border-solid border-surface-5 bg-bg-raised p-3 text-sm">
				<div class="flex justify-between gap-4">
					<span class="shrink-0 text-secondary">Copy from</span>
					<span class="truncate font-mono text-contrast" :title="candidate.sourcePath">
						{{ candidate.sourcePath }}
					</span>
				</div>
				<div class="mt-1 flex justify-between gap-4">
					<span class="shrink-0 text-secondary">Copy to</span>
					<span class="truncate font-mono text-contrast" :title="candidate.destinationPath">
						{{ candidate.destinationPath }}
					</span>
				</div>
				<div class="mt-1 flex justify-between gap-4">
					<span class="shrink-0 text-secondary">Approximate size</span>
